...
{ 
    ...
    outputSlider.setBounds(625, 50, 100, 100);
    ...
    mixSlider.setBounds(325, 50, 100, 100);
    ...
    threshSlider.setBounds(125, 75, 75, 75);
    ...
    ratioSlider.setBounds(187.5, 75, 75, 75);
    ...
    kneeSlider.setBounds(250, 75, 75, 75);
    ...
    attackSlider.setBounds(425, 75, 75, 75);
    ...
    releaseSlider.setBounds(487.5, 75, 75, 75);
    ...
    hpfSlider.setBounds(550, 75, 75, 75);
    ...
    help.setBounds(700, 20, 20, 20);
    help.setButtonText("?");
    addAndMakeVisible(help);
    
//    tabs.setSize(getWidth(), getHeight());
//    tabs.addTab("myTab", juce::Colours::ghostwhite, &tab, true);
//    tab.addChildComponent(&inputSlider);
//    tabs.addTab("myTab2", juce::Colours::ghostwhite, &tab2, true);
...
void CompressorTarrAudioProcessorEditor::buttonClicked (Button* button) // [2]
{
    
};
void CompressorTarrAudioProcessorEditor::sliderValueChanged(Slider* slider)
{
...
void CompressorTarrAudioProcessorEditor::paintMixDialBackground(Graphics& g)
{
    Path p1;
    Path p2;
    ColourGradient grade(Colours::green, 325, 125, Colours::red, 425, 125, false);
    g.setColour(Colours::grey);
    p1.addPieSegment(325, 50, 100, 100, -2.5, 2, 0.9);
    g.strokePath(p1, PathStrokeType(5));
    p2.addPieSegment(325, 50, 100, 100, -2.5, 2, 0.9);
    g.setGradientFill(grade);
    g.fillPath(p2);
   
};

void CompressorTarrAudioProcessorEditor::paintDialBackground(Graphics& g, int x, int y, int width, int height)
{
    Path p1;
    Path p2;
    Path p3;
...
void CompressorTarrAudioProcessorEditor::paint (Graphics& g)
{
    ...
    Image dialOut = ImageCache::getFromMemory(dial::knobOuter_png, dial::knobOuter_pngSize);
    
    
    g.fillAll (Colours::ghostwhite);
//    g.drawImageWithin(dialOut, 25, 25, 100, 100, RectanglePlacement(RectanglePlacement::stretchToFit));
    //g.drawEllipse(25, 25, 100, 100, 10);
    paintDialBackground(g, 25, 50, 100, 100);
    paintMixDialBackground(g);
    paintDialBackground(g, 625, 50, 100, 100);
    g.setColour(Colours::black);
    g.drawFittedText("input", 25, 110, 100, 100, Justification::centred, 1);
    g.drawFittedText("Thresh", 112, 110, 100, 100, Justification::centred, 1);
    g.drawFittedText("Ratio", 175, 110, 100, 100, Justification::centred, 1);
    g.drawFittedText("knee", 237, 110, 100, 100, Justification::centred, 1);
    g.drawFittedText("Mix", 325, 110, 100, 100, Justification::centred, 1);
    g.drawFittedText("Attack", 412, 110, 100, 100, Justification::centred,1 );
    g.drawFittedText("Release", 475, 110, 100, 100, Justification::centred, 1);
    g.drawFittedText("HPF", 537, 110, 100, 100, Justification::centred, 1);
    g.drawFittedText("make_up", 625, 110, 100, 100, Justification::centred, 1);
